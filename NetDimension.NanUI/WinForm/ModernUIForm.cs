...
namespace NetDimension.WinForm
{
    ...
    public partial class ModernUIForm : Form
    {
        ...
        {
            get { return isCustomFrameEnabled && FormBorderStyle != FormBorderStyle.None; }
            set
            {
        ...
        {
            get { return shadowDecorator.ActiveColor; }
            set
            {
                shadowDecorator.ActiveColor = value;
            }
        }
        ...
        {
            get { return shadowDecorator.InactiveColor; }
